    ...
    def backtrack(self, assignment, csp):
        ...
        for value in self.order_domain_values(var, assignment, csp):
            if csp.nconflicts(var, value, assignment) == 0:
                ...
                removals = []
                # inference = csp.infer_assignment()
                queue = self.get_queue(csp, var)
                if self.AC3(csp, queue, removals):
                    # if inference != None:
...
if __name__ == '__main__':
    ...
    board1 = sudoku.Sudoku('123456789.........123456789123456789123456789123456789123456789123456789123456789')
    board2 = sudoku.Sudoku('..3.2.6..9..3.5..1..18.64....81.29..7.......8..67.82....26.95..8..2.3..9..5.1.3..')
    board3 = sudoku.Sudoku('...7.46.3..38...51.1.9.327..34...76....6.8....62...98..473.6.1.68...13..3.12.5...')
    ...
    # print('##########')
    # board.display(board2)
    # print('##########')
    # board.display(board3)
    # print('##########')
    ...
    start = time.perf_counter()
    result = sol.backtracking_search(board)
    print("\n" + "time: " + str(time.perf_counter() - start))
    board.display(board)
    print(result)
